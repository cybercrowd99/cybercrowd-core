...
//
// Purpose:
// - Define permission boundary between XR runtime requests and cybercrowd-core.
// - Provide XR permission request/decision vocabulary.
// - Allow XR systems to request permission evaluation.
//
// Owns:
...
//
// Rule:
// XR may request permission evaluation.
// CORE remains the authority boundary for permissions.

export type XRCorePermissionDecisionReason =
  | "allowed-permission-evaluation"
  | "allowed-permission-context"
  | "blocked-unknown-request"
